...
public class RetweetGraphRepositoryImpl implements RetweetGraphRepositoryCustom {
    ...
    @Override
    public List<RetweetGraphEntity> findByUserId(String userId) {
        Query query = new Query(Criteria.where("userId").is(userId));
        return mongoTemplate.find(query, RetweetGraphEntity.class);
